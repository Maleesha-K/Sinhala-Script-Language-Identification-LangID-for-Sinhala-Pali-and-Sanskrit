...
input_dir = os.path.join(proj_root, "data_pipeline", "datasets", "raw_download", "flores_plus")
output_file = os.path.join(proj_root, "data_pipeline", "datasets", "preprocessed", "flores_plus.jsonl")
...
if not os.path.exists(raw_file_path):
    ...
    with open(raw_file_path, "r", encoding="utf-8") as f_in, \
        ...
        for line in f_in:
            ...
            standard_record = {
                "text": row["text"],
                "label": row.get("iso_639_3", row.get("label", "")),
                "source": "flores_plus"
            }
